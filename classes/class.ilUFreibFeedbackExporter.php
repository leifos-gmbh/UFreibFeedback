 ...
 */
class ilUFreibFeedbackExporter extends ilXmlExporter {
	...
	public function getXmlRepresentation($a_entity, $a_schema_version, $a_id) {
		...
		$entity = new ilObjUFreibFeedback($ref_id);

		include_once "./Services/Xml/classes/class.ilXmlWriter.php";
		$writer = new ilXmlWriter();
		$writer->xmlStartTag("xfrf");
	...
	public function getValidSchemaVersions($a_entity) {
		return array (
	         "5.2.0" => array(
	             "namespace" => "http://www.ilias.de/Plugins/UFreibFeedback/md/5_2",
